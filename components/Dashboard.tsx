...
const Dashboard = () => {
  ...
  function filterData(name: string, value: any) {
    if (value) {
      if (name === "CategoryFilter") {
        const categoryData = tableData?.filter((item: any) =>
  ...
  return (
    <div className="mx-auto container">
      <DashboardOverview />
      <div className="flex lg:flex-row flex-col justify-between py-6 lg:space-y-0 space-y-4">
        <div>
      ...
      <p className="text-[16px] lg:hidden block mb-2">
        <span className="text-red-600  font-bold">Note: </span>Drag
        to scroll on the table
      </p>
